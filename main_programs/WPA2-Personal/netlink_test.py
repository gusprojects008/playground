### EXPLORE THE iproute2 and socket netlink:
### iproute2 and socket netlink INTERACTS WITH THE LINUX KERNEL THROUGH THE NETLINK PROTOCOL USING SYSTEM CALLS. 
